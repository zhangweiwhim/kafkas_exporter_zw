...
func setup(topicFilter string, topicExclude string, groupFilter string, groupExclude string, logSarama bool, opts kafkaOpts) *prometheus.Registry {
	...
	consumergroupCurrentOffset = prometheus.NewDesc(
		...
		[]string{"consumergroup", "topic", "partition"}, opts.labels,
	)
	...
	consumergroupCurrentOffsetSum = prometheus.NewDesc(
		...
		[]string{"consumergroup", "topic"}, opts.labels,
	)
	...
	consumergroupMembers = prometheus.NewDesc(
		...
		[]string{"consumergroup"}, opts.labels,
	)
